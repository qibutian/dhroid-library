...
import  net.duohuo.dhroid.net.callback.AbsCallbackWrapper;
import  net.duohuo.dhroid.net.exception.OkGoException;
...
import  net.duohuo.dhroid.net.utils.HeaderParser;
...
public class CacheCall<T> implements Call<T> {
    ...
    public void execute(AbsCallback<T> callback) {
        ...
        mCallback = callback;
        if (mCallback == null) mCallback = new AbsCallbackWrapper<T>();
    ...
    @Override
    public Call<T> clone() {
        return new CacheCall<T>(baseRequest);
    }
