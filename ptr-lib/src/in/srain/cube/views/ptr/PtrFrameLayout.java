...
public class PtrFrameLayout extends ViewGroup {
	...
	protected void onFinishInflate() {
		...
		if (childCount > 2) {
			throw new IllegalStateException(
					"PtrFrameLayout can only contains 2 children");
	...
	private void layoutChildren() {
		...
		if (mHeaderView != null) {
			...
			// enhance readability(header is layout above screen when first
			// init)
	...
	public boolean dispatchTouchEvent(MotionEvent e) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			// if (Math.abs(offsetX) + 30 > Math.abs(offsetY)) {
	...
	public void setPreventForHorizontal(boolean mPreventForHorizontal) {
		this.mPreventForHorizontal = mPreventForHorizontal;
